...
// 激活的配送时间
const activeDeliveryTime = computed(() => {
  return deliveryTimeList.value[active.value]
})
 ...
 * @return {*}
 */
const onChangeDeliveryTime: UniHelper.SelectorPickerOnChange =
  e => {

  ...
  <scroll-view scroll-y class="orders">
    ...
    >
      ...
      <view class="status">
        ...
        <text
          v-if="order.orderState >= IOrderStatus.pendingReviews"
          class="icon-delete"
        ></text>
      </view>
...
import { getMemberOrderList } from '@/service'
...
const fetchMemberOrderList = async () => {
  const res = await getMemberOrderList(orderListParams)
  orderList.value = res.result.items
}

// 页面初始化
onMounted(() => {
  fetchMemberOrderList()
})
</script>

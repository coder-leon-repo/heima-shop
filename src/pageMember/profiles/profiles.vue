    ...
    <view class="form">
      ...
      <view class="form-content">
        <view class="form-item">
          ...
          <text class="account">{{ profiles?.account }}</text>
        </view>
        <view class="form-item">
        ...
        <view class="form-item">
          ...
          <picker
            class="picker"
            mode="region"
            :value="profiles?.fullLocation.split('')"
          >
            <view v-if="profiles?.fullLocation">{{
              profiles.fullLocation
            }}</view>
